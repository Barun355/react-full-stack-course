export const recipes = [
  {
    ...
    "category": "non-veg",
    "prevImage": "https://res.cloudinary.com/rf-automation-test/image/upload/w_1000,ar_1:1,c_fill,g_auto,e_art:hokusai/v1761985756/recipe-reveal/recipes-images/butter-chicken-makhani-1-1_ac0p8t.png",
    "image": "https://res.cloudinary.com/rf-automation-test/image/upload/c_fill,g_auto,h_250,w_970/b_rgb:000000,e_gradient_fade,y_-0.50/c_scale,co_rgb:ffffff,fl_relative,l_text:montserrat_25_style_light_align_center:Shop%20Now,w_0.5,y_0.18/v1761985756/recipe-reveal/recipes-images/butter-chiken-makhani-16-4_rsmcqd.png",
    "rating": 4.7,
    "reviews": 289,
    "prepTime": "20min",
    "cookTime": "40min",
    "calories": 340,
    "protein": 180,
    "description": "A popular North Indian dish rich ,creamy and mild spicy curry made with marinated chicken cooked in a tandoor and simmered in a velvety tomato sauce with butter and cream. Can be served with Roti ,naan or rice",
    "ingredients": [
      {
  ...
  },
  {
    ...
    "calories": 280,
    "protein": 14,
    "description": "Healthy and protein-rich savory pancakes made from moong dal. Perfect for breakfast or evening snack.",
    "ingredients": [
      {
    ...
    "servingSuggestions": [
      "Serve immediately while hot and crispy, stacked or individually plated.",
      "Pair with a fresh green chutney (like mint-coriander chutney) or tomato ketchup.",
      "Offer a side of plain yogurt or a raita for a cooling contrast."
    ],
    "tipsAndTricks": [
  ...
  },
  {
    ...
    "calories": 350,
    "protein": 16,
    "description": "Creamy spinach curry with soft paneer cubes. A nutritious and delicious North Indian classic.",
    "ingredients": [
      {
        "name": "Spinach (Palak)",
        "quantity": "500g",
    ...
    "servingSuggestions": [
      "Serve hot in a rustic bowl, garnished with a swirl of fresh cream or a few drops of butter.",
      "Accompany with warm naan, roti, or fluffy jeera rice for a complete meal.",
      "A wedge of lemon on the side can add a refreshing touch."
    ],
    "tipsAndTricks": [
  ...
  },
  {
    ...
    "calories": 320,
    "protein": 8,
    "description": "Crispy rice and lentil crepe filled with spiced potato filling. A South Indian breakfast favorite.",
    "ingredients": [
      {
        "name": "Dosa Rice",
        "quantity": "2 cups",
    ...
    "servingSuggestions": [
      "Serve the crispy Masala Dosa hot, with a dollop of coconut chutney and a side of savory sambar.",
      "Arrange on a banana leaf for an authentic South Indian experience.",
      "A small bowl of tomato chutney or ginger chutney can also be served alongside."
    ],
    "tipsAndTricks": [
  ...
  },
  {
    ...
    "calories": 520,
    "protein": 15,
    "description": "Spicy chickpea curry served with fluffy deep-fried bread. A popular North Indian breakfast dish.",
    "ingredients": [
      {
        "name": "Chickpeas",
        "quantity": "2 cups",
    ...
    "servingSuggestions": [
      "Serve the hot, fluffy bhature alongside a bowl of spicy Chole.",
      "Garnish Chole with fresh coriander, finely chopped red onions, and a squeeze of lemon juice.",
      "Accompany with a side of traditional Indian pickles (achaar) and refreshing mint chutney."
    ],
    "tipsAndTricks": [
  ...
  },
  {
    ...
    "calories": 280,
    "protein": 28,
    "description": "Light and flavorful Bengali fish curry cooked in mustard and tomato gravy. Best served with steamed rice.",
    "ingredients": [
      {
    ...
    "servingSuggestions": [
      "Serve hot with a generous portion of steamed Basmati rice, allowing the rice to soak up the flavorful gravy.",
      "Garnish with fresh coriander leaves and slit green chilies for an aromatic finish.",
      "A wedge of lime can be served on the side for an optional tangy kick."
    ],
    "tipsAndTricks": [
  ...
  },
  {
    ...
    "calories": 310,
    "protein": 7,
    "description": "Fragrant one-pot rice dish cooked with mixed vegetables and aromatic spices. Perfect for lunch.",
    "ingredients": [
      {
        "name": "Basmati Rice",
        "quantity": "2 cups",
    ...
    "servingSuggestions": [
      "Serve hot in a large serving dish, garnished with fresh coriander leaves and a few fried onions.",
      "Best enjoyed with a side of cooling Raita (cucumber or boondi raita) and a fresh green salad.",
      "Can be paired with a mild curry or dal for a more substantial meal."
    ],
    "tipsAndTricks": [
  ...
  },
  {
    ...
    "calories": 290,
    "protein": 14,
    "description": "Simple and delicious curry made with boiled eggs in spiced onion-tomato gravy. Quick weeknight dinner option.",
    "ingredients": [
      {
        "name": "Eggs",
        "quantity": "6",
    ...
    "servingSuggestions": [
      "Serve the hot Egg Curry with steamed Basmati rice, soft rotis, or parathas.",
      "Garnish generously with fresh coriander leaves for added flavor and visual appeal.",
      "A simple onion-cucumber salad can provide a refreshing accompaniment."
    ],
    "tipsAndTricks": [
  ...
  },
  {
    ...
    "calories": 340,
    "protein": 16,
    "description": "Hearty kidney bean curry in thick tomato-onion gravy. A protein-rich North Indian comfort food.",
    "ingredients": [
      {
    ...
    "servingSuggestions": [
      "Serve hot with freshly cooked Basmati or Jeera rice for a classic combination.",
      "Garnish with fresh coriander leaves and thin ginger juliennes for an aromatic finish.",
      "Accompany with sliced raw onions, green chilies, and a squeeze of lime juice.",
      "Best served in a traditional deep bowl to capture the rich gravy."
    ],
    "tipsAndTricks": [
      "Rajma must be very soft for best curry",
      "Slow cooking enhances flavors",
